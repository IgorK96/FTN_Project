...
################################################################
# This is a generated script based on design: rsa_project_bd
#
...
# source rsa_project_bd_script.tcl
...
set design_name rsa_project_bd
...
proc create_root_design { parentCell } {
  ...
  set rsa_0 [ create_bd_cell -type ip -vlnv user.org:user:rsa:1.0 rsa_0 ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins ps7_0_axi_periph/M00_AXI] [get_bd_intf_pins rsa_0/S00_AXI]
  ...
  connect_bd_intf_net -intf_net rsa_0_BRAM_A [get_bd_intf_pins blk_mem_gen_0/BRAM_PORTB] [get_bd_intf_pins rsa_0/BRAM_A]
  connect_bd_intf_net -intf_net rsa_0_BRAM_B [get_bd_intf_pins blk_mem_gen_1/BRAM_PORTB] [get_bd_intf_pins rsa_0/BRAM_B]

  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_bram_ctrl_1/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rsa_0/s00_axi_aclk] [get_bd_pins rst_ps7_0_5M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_ps7_0_5M_peripheral_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_1/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rsa_0/s00_axi_aresetn] [get_bd_pins rst_ps7_0_5M/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs rsa_0/S00_AXI/S00_AXI_reg] SEG_rsa_0_S00_AXI_reg
